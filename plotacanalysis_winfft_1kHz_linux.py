...
if 0:
    x=numpy.load('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fakefft_voltage.npy')[:, :, 0]
    
if 0:
    x=numpy.load('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fakefft_current.npy')[:, :, 0]

if 0:
    x=numpy.load('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fake2fft_smoothrcurrent.npy')[:, :, 0]
if 0:
...
if 0:
    ...
    if 1:
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fake_voltage.npy', fakedata)
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fakefft_voltage.npy', fakefft[:, :22, :])
    if 0:
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fake_current.npy', fakedata)
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fakefft_current.npy', fakefft[:, :22, :])
...
if 1:
    ...
    rsmooth=savgolsmooth(r, nptsoneside=300, order = 1)
    ...
    fakefft=numpy.array(fakefft).swapaxes(0,2).swapaxes(0,1)
    if 1:
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fake2_smoothrcurrent.npy', fakedata)
        numpy.save('/mnt/hgfs/HostDocuments/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/fake2fft_smoothrcurrent.npy', fakefft[:, :22, :])
