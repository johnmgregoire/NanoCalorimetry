...
v1wsmooth=savgolsmooth(fftva[:, find_1w], nptsoneside=smoothpts, order = 1)*fftfudgefactor
c1wsmooth=savgolsmooth(fftca[:, find_1w], nptsoneside=smoothpts, order = 1)*fftfudgefactor
v2wsmooth=savgolsmooth(fftva[:, find_1w*2], nptsoneside=smoothpts, order = 1)*fftfudgefactor
...
if 1:
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/mcfft.npy', mc)

if 1:
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/v1wsmooth.npy', v1wsmooth)
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/c1wsmooth.npy', c1wsmooth)
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/v2wsmooth.npy', v2wsmooth)
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/rsmooth.npy', r)
    numpy.save('C:/Users/JohnnyG/Documents/HarvardWork/ACcal/20110714_Sn_analysis/Aug31kHzanalysis/T.npy', T)
...
for i, (data, nam) in enumerate(zip([vsmoothdc, csmoothdc, v1wsmooth, c1wsmooth, v2wsmooth,r, mc, mcmol], ['vsmoothdc', 'csmoothdc', 'v1wsmooth', 'c1wsmooth', 'v2wsmooth', 'R','$i^2 I R k / V_{2\omega}\omega$ (J/K)', ' 75nmol, mc (J/K/mol)'])):
